...
export class RulesNavigationService extends NavigationService {
  ...
  constructor() {
    ...
    this.setPages([
      ...
      { order: 9, id: 'standard-abilities', title: 'Standard Abilities', route: '/rules/standard-abilities', parent: 'combat' },
      { order: 10, id: 'movement', title: 'Movement', route: '/rules/movement', parent: 'combat' },
